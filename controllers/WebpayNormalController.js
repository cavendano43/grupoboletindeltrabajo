...
const cons=require("../cert/webpay/config");
const config=new Transbank.Configuration()
.withCommerceCode(cons.commerceCode)
.withPrivateCert(cons.privateKey)
.withPublicCert(cons.publicKey).usingEnvironment(Transbank.environments.production);
